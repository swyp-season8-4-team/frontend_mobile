...
class DessertModifyStep1 extends ConsumerStatefulWidget {
  const DessertModifyStep1({super.key});

  @override
  ConsumerState<DessertModifyStep1> createState() => _DessertModifyStep1State();
}

class _DessertModifyStep1State extends ConsumerState<DessertModifyStep1> {
  bool isNextButtonActivate = true;
  ...
  void initState() {
    ...
    switch (state.data.mateCategory) {
      case '친목도모':
            ...
            children: <Widget>[
              ...
              CustomFillButton.large(
                ...
                onPressed: () {
                  ...
                  context.pushNamed(
                    AppRoutes.dessertModifyStep2.name,
                    extra: subject,
                  );
                },
              ),
