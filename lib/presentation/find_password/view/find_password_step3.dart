...
class _FindPasswordStep3State extends ConsumerState<FindPasswordStep3> {
  ...
  void _onSubmit() {
    final PasswordResetParams state = ref.read(findPasswordProvider);
    ...
    ref
        ...
        .postPasswordReset(
          params: PasswordResetParams(
            ...
            confirmNewPassword: _passwordCheckController.text,
          ),
        );
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(findPasswordViewModelProvider, (_, FindPasswordState next) {
      switch (next.passwordResetStatus) {
        case Status.success:
          showDialog(
            context: context,
    ...
    return CustomLoadingOverlay(
      isLoading: state.passwordResetStatus.isLoading,
