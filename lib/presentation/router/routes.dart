...
abstract class AppRoutes {
  ...
  // 지도 > 가게 상세 > 리뷰 신고
  static final RouteInfo reportStoreReview = RouteInfo(
    name: '${storeDetail.name}/:reviewUuid/report',
    path: ':reviewUuid/report',
  );

  // 지도 > 가게 상세 > 리뷰 신고 성공
  static final RouteInfo successReportStoreReview = RouteInfo(
    name: '${storeDetail.name}/success_report_review',
    path: 'success_report_review',
  );
  ...
  /// 디저트 메이트 > 게시판 > 게시글 > 게시글 신고 > 성공
  static RouteInfo dessertPostReportSuccess = RouteInfo(
    name: '${dessertPostReport.name}/success',
    path: 'success',
  );
