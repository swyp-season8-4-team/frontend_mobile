...
final Provider<PostBlockUserUsecase> postBlockUserUsecaseProvider =
    Provider<PostBlockUserUsecase>((Ref ref) {
      return PostBlockUserUsecase(repository: ref.read(userRepositoryProvider));
    });

class PostBlockUserUsecase
    implements Usecase<BlockedUserModel, BlockUserParams> {
  const PostBlockUserUsecase({required UserRepository repository})
  ...
  Future<Result<BlockedUserModel, CustomException>> call({
    ...
    return await _repository.postBlockUser(params: params);
  }
}
