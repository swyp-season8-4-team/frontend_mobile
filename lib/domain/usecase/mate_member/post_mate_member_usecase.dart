...
final Provider<PostMateMemberUsecase> postMateMemberUsecaseProvider =
    Provider<PostMateMemberUsecase>(
      (Ref ref) => PostMateMemberUsecase(
        repository: ref.read(mateMemberRepositoryProvider),
      ),
    );

class PostMateMemberUsecase
    extends Usecase<MateMemberModel, PostMateMemberParams> {
  PostMateMemberUsecase({required this.repository});
  ...
  Future<Result<MateMemberModel, CustomException>> call({
    ...
    return await repository.postMateMember(params: params);
  }
}
