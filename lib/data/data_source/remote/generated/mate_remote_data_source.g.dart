...
class _MateRemoteDataSource implements MateRemoteDataSource {
  ...
  @override
  Future<MateEntity> getMyMates({required GetMyMateQueryParam query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query.toJson());
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<MateDetailEntity> postMate({required FormData formData}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<MateReportEntity> postMateReport({
    ...
    required PostMateReportRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<MateReportEntity>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/mates/${mateUuid}/report',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MateReportEntity _value;
    try {
      _value = MateReportEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<MatePatchEntity> patchMate({
    ...
    final _headers = <String, dynamic>{};
    final _data = formData;
    final _options = _setStreamType<MatePatchEntity>(
      Options(
            method: 'PATCH',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MatePatchEntity _value;
    try {
      _value = MatePatchEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<MateDeleteEntity> deleteMate({required String mateUuid}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MateDeleteEntity>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MateDeleteEntity _value;
    try {
      _value = MateDeleteEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
