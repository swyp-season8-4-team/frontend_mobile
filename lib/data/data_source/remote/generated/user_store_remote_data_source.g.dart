...
part of '../user_store_remote_data_source.dart';
...
class _UserStoreRemoteDataSource implements UserStoreRemoteDataSource {
  _UserStoreRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<void> addStoreToUserStoreList({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user-store/lists/${listId}/stores/${storeUuid}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<UserStoreListDetailEntity> getStoresByUserStoreList({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserStoreListDetailEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user-store/lists/${listId}/stores',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserStoreListDetailEntity _value;
    try {
      _value = UserStoreListDetailEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<UserStoreLocationEntity>> getUserStoreLocations({
    ...
    final _options = _setStreamType<List<UserStoreLocationEntity>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/user-store/lists/${listId}/stores/locations',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
