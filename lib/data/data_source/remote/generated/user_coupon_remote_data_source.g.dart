...
part of '../user_coupon_remote_data_source.dart';
...
class _UserCouponRemoteDataSource implements UserCouponRemoteDataSource {
  _UserCouponRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<void> issueCoupon({required IssueCouponRequestBody body}) async {
  ...
  Future<UserCouponDetailEntity> getMyCouponDetail({
    ...
    final _options = _setStreamType<UserCouponDetailEntity>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/users/coupons/my/${userCouponId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
